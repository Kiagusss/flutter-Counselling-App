                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 20),
                      child: Text(
                        "Embark on a journey of self-discovery with MindScape",
                        style: GoogleFonts.nunito(
                            fontSize: 28,
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 20),
                      child: Text(
                        "We prioritize your privacy and confidentiality during counseling sessions.",
                        style: GoogleFonts.nunito(
                            fontSize: 28,
                            fontWeight: FontWeight.w600,
                            color: Colors.grey),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 20),
                      child: Text(
                        "Find guidance and support on your path to success with Mind Scape.",
                        style: GoogleFonts.nunito(
                            fontSize: 28,
                            fontWeight: FontWeight.w600,
                            color: Colors.grey),
